...
$post_keys = array("jmeno", "telefon", "email", "poznamkaSalon", "provedeni", "vyzvednuti", "dorucovaciAdresa", "hodnota", "hodnotaVlastni", "cenaVcetnePostovneho", "kodPoukazu", "obdarovana", "prani", "variabilniSymbol" );

$keys_labels = array("jmeno" => "Jméno objednavatele: ", "telefon" => "Telefon: ", "email" => "E-mail: ", "poznamkaSalon" => "Poznámka do salonu: ", "provedeni" => "Varianta poukazu: ", "vyzvednuti" => "Vyzvednutí: ", "dorucovaciAdresa" => "Poukaz doručíme na adresu: ", "hodnota" => "HODNOTA POUKAZU (v Kč): ", "hodnotaVlastni" => "VLASTNÍ HODNOTA POUKAZU (v Kč): ", "cenaVcetnePostovneho" => "CENA VČETNĚ POŠTOVNÉHO: ", "kodPoukazu" => "Kód poukazu: ", "obdarovana" => "Pro: ", "prani" => "Přání k poukazu: ", "variabilniSymbol" => "Variabilní symbol: ");
...
if($keys_exists){
	...
	if($data["vyzvednuti"] == '') {
		$content .=  "<br><br>" . "<b>" . "PLATEBNÍ ÚDAJE:<br>- - - - - - - - - - - - - - -<br>číslo účtu:</b> 288850775/0300<br><b>variabilní symbol:</b> " . $data["variabilniSymbol"] . "<br>" . "<b>Částka k zaplacení (v Kč):</b> " . $data["hodnota"] . "<br>" . $data["hodnotaVlastni"] . "<br><br>";
	}
	...
	$content .= "<br><br><hr>";
	$content .= "Žadatel / Žadatelka odesláním této poptávky souhlasil/a se zpracováním svých osobních údajů. Souhlas byl udělen dnem odeslání této žádosti na dobu nezbytně nutnou pro dokončení objednávky dárkového poukazu.";
